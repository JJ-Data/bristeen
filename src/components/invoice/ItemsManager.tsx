    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <input type="number" value={newPrice} onChange={e => setNewPrice(e.target.value)} placeholder="Default price (₦) *" min="0"
            className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400" />
          <input value={newUnit} onChange={e => setNewUnit(e.target.value)} placeholder="Unit (e.g. per plate)"
            className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400" />
        </div>
                    ...
                    <>
                      <td className="px-5 py-3">
                        <input value={editValues.name} onChange={e => setEditValues(v => ({ ...v, name: e.target.value }))}
                          className="border border-amber-300 rounded px-2 py-1 text-sm w-full focus:outline-none focus:ring-2 focus:ring-amber-400" />
                      </td>
                      ...
                      <td className="px-5 py-3">
                        <input type="number" value={editValues.default_price} onChange={e => setEditValues(v => ({ ...v, default_price: e.target.value }))}
                          className="border border-amber-300 rounded px-2 py-1 text-sm w-full text-right focus:outline-none focus:ring-2 focus:ring-amber-400" />
                      </td>
                      <td className="px-5 py-3">
