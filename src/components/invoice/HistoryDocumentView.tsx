...
export default function HistoryDocumentView({ invoice }: { invoice: Invoice }) {
  ...
  async function handleDelete() {
    ...
    router.push('/admin/invoicing/history')
    router.refresh()
  }
  ...
  async function handleDuplicate() {
    ...
    router.push(`/admin/invoicing/history/${copy.id}`)
  }
  ...
  async function handleCreateReceipt() {
    ...
    router.push(`/admin/invoicing/history/${receipt.id}`)
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm flex flex-wrap items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          {current.type === 'invoice' && (
            <button onClick={handleCreateReceipt} disabled={converting}
      ...
      <InvoicePreview invoice={{ ...current, status }} onBack={() => router.push('/admin/invoicing/history')} />
    </div>
  )
}
