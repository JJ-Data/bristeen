...
import { LayoutDashboard, Package, BarChart3, Settings, LogOut, ShoppingCart, FileText, CalendarDays } from "lucide-react";
...
export function Sidebar() {
    ...
    const links = [
        ...
        { href: "/events", label: "Catering Events", icon: CalendarDays },
